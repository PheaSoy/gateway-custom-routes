...
public class InternalApiRouteController {
    ...
    private ApiRouteResponse convertApiRouteIntoApiRouteResponse(ApiRoute apiRoute) {
        return ApiRouteResponse.builder()
                ...
                .uri(apiRoute.getUri())
                .createdAt(apiRoute.getCreatedAt().getTime())
                .updatedAt(apiRoute.getUpdatedAt().getTime())
                .enabled(apiRoute.getEnabled())
                .connectTimeout(apiRoute.getConnectTimeout())
                .readTimeout(apiRoute.getReadTimeout())
                .build();
    }
}
